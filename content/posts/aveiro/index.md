...
{{< gallery >}}
    <img src="img/sul.jpg" class="grid-w50" />
    <img src="img/plamenaci.jpg" class="grid-w50" />
{{< /gallery >}}
...
To je takový fazolový guláš s různými druhy masa - v našem případě vepřovým masem, klobásou a vepřovými jazyky.
...
{{< gallery >}}
    <img src="img/plaz.jpg" class="grid-w50" />
    <img src="img/plaz2.jpg" class="grid-w50" />
    <img src="img/plaz3.jpg" class="grid-w100" />
{{< /gallery >}}
